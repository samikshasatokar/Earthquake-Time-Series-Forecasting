...
def dep_lstm():
    ...
    # Commented out IPython depic to ensure Python compatibility.
    # %matplotlib inline

    # https://stackoverflow.com/questions/4761623/how-to-change-the-color-of-the-axis-ticks-and-labels-for-a-plot-in-matplotlib
    f1 = plt.figure(facecolor='black', figsize=(15, 9))
    plt.plot(test_set, color='#FEC8D8', label='Real Depth')
    ax = plt.axes()
    ...
    f2 = plt.figure(facecolor='black', figsize=(15, 9))
    plt.plot(predicted_values, color='#E0BBE4', label='Predicted Depth')
    ax = plt.axes()
    ax.set_facecolor("black")
    ax.tick_params(axis='x', colors='white')
    ax.tick_params(axis='y', colors='white')
